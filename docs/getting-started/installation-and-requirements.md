...
1. Check out the **Quick Start Guide** to learn how to setup your own characters or use the included ones.  
[Read More → Quick Start Guide](xref:quick-start-guide)
