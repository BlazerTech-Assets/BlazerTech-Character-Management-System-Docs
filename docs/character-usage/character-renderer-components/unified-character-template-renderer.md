---
uid: unified-character-template-renderer-component
...
![Add Unified Character Template Renderer Component](~/images/components/character-renderer-components/unified-character-template-renderer/add-component.png)
